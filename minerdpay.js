  ...
  async create_payment(value, time = 30) {
    ...
    this.response = await requests({
      ...
      json: {
        ...
        description: "Minerd Pagamentos",
        payment_method_id: "pix",
        payer: {
          email: "minerd@gmail.com",
    ...
    this.payment_id = this.payment.id ? this.payment.id.toString() : null;
...
module.exports = { requests, payment }
